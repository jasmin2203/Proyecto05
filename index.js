const categoriaAPI='https://disenoydesarrolloapi.azurewebsites.net/api/Producto/Categorias';
const productoAPI = 'https://disenoydesarrolloapi.azurewebsites.net/api/Producto';
